...
import PurchasingProfileSettings from '../../components/user-dashboard/PurchasingProfileSettings';



const PurchasingUserProfilePage: React.FC = () => {
        ...
        <div className="h-full overflow-y-auto flex-1 p-4">
          <div className="mx-auto">
            <div className="bg-white rounded border border-gray-200">
              ...
              <div className="p-4">
                {activeTab === 'profile' && <PurchasingProfileSettings />}
...
export default PurchasingUserProfilePage;