...
const TermsAndConditions: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <HeaderBanner
        title="Peace Bijouterie Terms and Conditions"
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600">
            Welcome to <strong>Peace Bijouterie</strong>! By accessing or using our website (<a href="http://www.peacebijouterie.rw" className="text-primary-600 hover:underline">www.peacebijouterie.rw</a>) and services, you agree to comply with and be bound by the following Terms and Conditions.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            <li>Peace Bijouterie is an online jewelry retailer based in Kigali, Rwanda.</li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            ...
            <li>Peace Bijouterie reserves the right to refuse or cancel any order for reasons including stock unavailability, payment issues, or suspected fraud.</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            ...
            <li>Peace Bijouterie is not responsible for delays caused by external factors such as courier issues, weather, or customs clearance.</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            <li>Peace Bijouterie strives to ensure all product descriptions, images, and pricing are accurate.</li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            ...
            <li>You agree to notify Peace Bijouterie immediately of any unauthorized use of your account.</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            <li>All content on the Peace Bijouterie website, including images, designs, logos, and text, is protected by copyright and intellectual property laws.</li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            <li>Peace Bijouterie collects personal information for order processing, shipping, and marketing purposes.</li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            <li>Peace Bijouterie is not liable for any direct, indirect, incidental, or consequential damages arising from the use of our website or products.</li>
            <li>Jewelry use is at the customer’s own discretion, and Peace Bijouterie is not responsible for damage caused by misuse.</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            <li>Peace Bijouterie reserves the right to update or modify these Terms and Conditions at any time.</li>
        ...
        <section className="mb-12">
          <p className="text-gray-600 italic">
            By using Peace Bijouterie services, you acknowledge that you have read, understood, and agreed to these Terms and Conditions.
          </p>
        </section>
