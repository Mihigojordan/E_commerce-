        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
              ...
              {newProductsLoading ? (
                ...
                <div className="space-y-4 sm:space-y-5">
                  {newProducts.map((product) => (
                    <div
                      key={product.id}
                      className="flex gap-3 sm:gap-4 group cursor-pointer p-2 rounded-lg hover:bg-gray-50 transition-colors"
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-medium text-gray-900 group-hover:text-primary-600 transition-colors text-sm sm:text-base truncate">
                          {product.name}
                        </h4>
          ...
          <main className="flex-1 min-w-0">
            ...
            <motion.div
              ...
              animate={{ y: 0, opacity: 1 }}
              transition={{ delay: 0.1 }}
              className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4 bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100"
            >
              <div>
            ...
            {loading ? (
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-center text-gray-600 py-12 bg-white rounded-xl shadow-sm border border-gray-100"
              >
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12"
              >
                <AnimatePresence>
            ...
            {pagination.total > 0 && pagination.totalPages > 1 && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100"
              >
                <button
