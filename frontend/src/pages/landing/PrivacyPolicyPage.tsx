...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <HeaderBanner
        title="Peace Bijouterie Privacy Policy"
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600">
            At <strong>Peace Bijouterie</strong>, your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your personal information when you use our website (<a href="http://www.peacebijouterie.rw" className="text-primary-600 hover:underline">www.peacebijouterie.rw</a>) and services.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 mb-2">When you interact with Peace Bijouterie, we may collect the following information:</p>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            <li>Peace Bijouterie uses cookies and similar technologies to enhance website functionality, track browsing behavior, and improve the shopping experience.</li>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 mt-2">
            To exercise these rights, contact us at <a href="mailto:support@peacebijouterie.rw" className="text-primary-600 hover:underline">support@peacebijouterie.rw</a>.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600">
            Peace Bijouterie does not knowingly collect personal information from children under 18. If you are under 18, please do not use our services.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li className="flex items-center gap-2">
              ...
              <span><strong>Address</strong>: Peace Bijouterie Shop, Kigali, Rwanda</span>
            </li>
          </ul>
          <div className="mt-6">
            <a
